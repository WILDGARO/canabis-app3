...
const Color backgroundColor = Color(0xFF161616);
const Color whiteColor = Color(0xFFFFFFFF);
const Color greyColor = Color(0xFF808d9e);
const Color yellowColor = Color(0xFFE8FB7A);
const Color btnGoogleColor = Color(0xFF262832);
...
TextStyle urbanistTextStyle = GoogleFonts.urbanist();
